...
(function (t, n) {
        ...
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h, b = a + p, w = c + d, M = md(x * x + b * b + w * w), T = Ge(w /= M),
                    k = sd(sd(w) - 1) < ed || sd(o - l) < ed ? (o + l) / 2 : ld(b, x), N = t(k, T), S = N[0], E = N[1],
    ...
    function Da(t, n, e, r, i, o, u) {
        var a = t - e, c = n - r, s = (u ? o : -o) / lg(a * a + c * c), f = s * c, l = -s * a, h = t + f, p = n + l,
            ...
            w = h * v - d * p, M = (m < 0 ? -1 : 1) * lg(cg(0, b * b * x - w * w)), T = (w * m - g * M) / x,
    ...
    var Xh = function (t) {
        ...
        }, $h = Xh(","), Vh = $h.parse, Wh = $h.parseRows, Zh = $h.format, Gh = $h.formatRows, Jh = Xh("\t"), Qh = Jh.parse,
        Kh = Jh.parseRows, tp = Jh.format, np = Jh.formatRows, ep = function (t) {
            return function () {
                return t
            }
        }, rp = function () {
    ...
    var up, ap = 10, cp = Math.PI * (3 - Math.sqrt(5)), sp = function (t, n) {
        ...
        "": function (t, n) {
            ...
            var e = sp(t, n);
            if (!e) return t + "";
            var r = e[0], i = e[1], o = i - (up = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, u = r.length;
    ...
    var _p, yp = function (t) {
        return t
    }, gp = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"], mp = function (t) {
        function n(t) {
            function n(t) {
                var n, r, u, f = _, x = y;
        ...
        return {
            format: n, formatPrefix: function (t, e) {
                var r = n((t = He(t), t.type = "f", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(fp(e) / 3))),
                    o = Math.pow(10, -i), u = gp[8 + i / 3];
                return function (t) {
                    return r(o * t) + u
                }
            }
    ...
    var Tp, kp, Np, Sp, Ep, Ap, Cp, zp, Pp, Rp, Lp, qp, Up, Dp, Op, Fp, Ip, Yp, Bp, jp, Hp, Xp, $p, Vp, Wp, Zp, Gp, Jp,
        Qp, Kp, td, nd = new Ve, ed = 1e-6, rd = Math.PI, id = rd / 2, od = rd / 4, ud = 2 * rd, ad = 180 / rd,
    ...
    var Pd, Rd, Ld, qd, Ud, Dd, Od, Fd, Id, Yd, Bd, jd = function (t) {
        ...
        for (var a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + od, d = yd(p), v = hd(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
            var y = s[_], g = y[0], m = y[1] / 2 + od, x = yd(m), b = hd(m), w = g - h, M = w >= 0 ? 1 : -1, T = M * w,
                k = T > rd, N = d * x;
    ...
    var Uy = Date.prototype.toISOString ? function (t) {
        ...
        }, og = Math.abs, ug = Math.atan2, ag = Math.cos, cg = Math.max, sg = Math.min, fg = Math.sin, lg = Math.sqrt,
        hg = 1e-12, pg = Math.PI, dg = pg / 2, vg = 2 * pg;
    Oa.prototype = {
        areaStart: function () {
            this._line = 0
        }, areaEnd: function () {
    ...
    }, zg = Math.sin(pg / 10) / Math.sin(7 * pg / 10), Pg = Math.sin(vg / 10) * zg, Rg = -Math.cos(vg / 10) * zg, Lg = {
        draw: function (t, n) {
    ...
    t.version = "4.10.0", t.bisect = hs, t.bisectRight = hs, t.bisectLeft = ps, t.ascending = ss, t.bisector = fs, t.cross = function (t, n, r) {
        ...
        var e = t[0] * cd, r = t[1] * cd, i = n[0] * cd, o = n[1] * cd, u = hd(r), a = yd(r), c = hd(o), s = yd(o),
            f = u * hd(e), l = u * yd(e), h = c * hd(i), p = c * yd(i), d = 2 * Ge(md(Je(o - r) + u * c * Je(i - e))),
            v = yd(d), _ = d ? function (t) {
        ...
        function t() {
            var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - dg,
                p = u.apply(this, arguments) - dg, d = og(p - h), v = p > h;
            if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > hg) if (d > vg - hg) c.moveTo(l * ag(h), l * fg(h)), c.arc(0, 0, l, h, p, !v), f > hg && (c.moveTo(f * ag(p), f * fg(p)), c.arc(0, 0, f, p, h, v)); else {
                ...
                if (N > hg) {
                    ...
                    if (d < pg) {
                        var F = w > hg ? Ua(z, P, D, O, q, U, R, L) : [R, L], I = z - F[0], Y = P - F[1], B = q - F[0],
                            j = U - F[1], H = 1 / fg(Aa((I * B + Y * j) / (lg(I * I + Y * Y) * lg(B * B + j * j))) / 2),
